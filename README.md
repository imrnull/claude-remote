...
| $5 | COMMIT_PREFIX | No | `""` | Prefix for commits (e.g., `"BP25-123 - "`) |
| $6 | PROMPT | Yes | - | Task description (new) or user response (continuation) |
| $7 | SOURCE_BRANCH | No | `main` | Branch to create feature branch from |
...
3. Checkout source branch (default: `main`)
4. Create branch: `feature/BRANCH_NAME`
5. Run Claude with task description + system prompt (includes COMMIT_PREFIX)
